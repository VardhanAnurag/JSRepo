...
<title>Banner Demo</title>
	<link rel="stylesheet" type="text/css" href="./assets/css/com/org/banner/banner.css">
	</link>	
	...
	<script language="JavaScript" src="./assets/javascript/com/org/banner/banner.js">
	</script>
...
<body  style="margin: 0px;" onscroll="scrollHere();">
  ...
  <div id="content">
	  <a href="javascript:void(0)" onclick="new Banner().info('Your request has been successfully received.');">Success</a> |
	  <a href="javascript:void(0)" onclick="new Banner().warning('You must enter all required information.');">Warning</a> |
	  <a href="javascript:void(0)" onclick="new Banner().error('You have encountered a critical error.');">Error</a>
  </div>
